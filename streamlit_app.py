...
FACTORES_INTEGRADOS = pd.DataFrame(
    [
        ...
        {
            "perfil": "GLEC v3.2 | Marítimo contenedor | Promedio industria | Seco | Emisiones de ciclo energético completo",
            "modo": "Marítimo",
        ...
        {
            "perfil": "GLEC v3.2 | Marítimo contenedor | Promedio industria | Reefer | Emisiones de ciclo energético completo",
            "modo": "Marítimo",
            "metodo": "Intensidad de emisión",
            "intensidad_wtt_g_tkm": None,
            "intensidad_ttw_g_tkm": None,
        ...
        {
            "perfil": "GLEC v3.2 | Marítimo contenedor | Asia ↔ Sudamérica | Seco | Emisiones de ciclo energético completo",
            "modo": "Marítimo",
            "metodo": "Intensidad de emisión",
            "intensidad_wtt_g_tkm": None,
            "intensidad_ttw_g_tkm": None,
        ...
        {
            "perfil": "GLEC v3.2 | Marítimo contenedor | Asia ↔ Sudamérica | Reefer | Emisiones de ciclo energético completo",
            "modo": "Marítimo",
            "metodo": "Intensidad de emisión",
            "intensidad_wtt_g_tkm": None,
            "intensidad_ttw_g_tkm": None,
...
_RENOMBRE_PERFILES = {
    "GLEC v3.2 | Marítimo contenedor | Promedio industria | Seco | WTW": "GLEC v3.2 | Marítimo contenedor | Promedio industria | Seco | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Marítimo contenedor | Promedio industria | Reefer | WTW": "GLEC v3.2 | Marítimo contenedor | Promedio industria | Reefer | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Marítimo contenedor | Asia ↔ Sudamérica | Seco | WTW": "GLEC v3.2 | Marítimo contenedor | Asia ↔ Sudamérica | Seco | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Marítimo contenedor | Asia ↔ Sudamérica | Reefer | WTW": "GLEC v3.2 | Marítimo contenedor | Asia ↔ Sudamérica | Reefer | Emisiones de ciclo energético completo",
    ...
    "Uruguay | Aéreo | Jet A1 | TTW": "Uruguay | Aéreo | Jet A1 | Emisiones operativas",
    "GLEC v3.2 | Carretero | Diésel 100% | WTW": "GLEC v3.2 | Carretero | Diésel | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Ferroviario | Diésel 100% | WTW": "GLEC v3.2 | Ferroviario | Diésel | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Marítimo | MDO/MGO VLSFO | WTW": "GLEC v3.2 | Marítimo | MDO/MGO VLSFO | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Marítimo | HFO VLSFO | WTW": "GLEC v3.2 | Marítimo | HFO VLSFO | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Fluvial | MDO/MGO VLSFO | WTW": "GLEC v3.2 | Fluvial | MDO/MGO VLSFO | Emisiones de ciclo energético completo",
    "GLEC v3.2 | Aéreo | Jet A1/A | WTW": "GLEC v3.2 | Aéreo | Jet A1/A | Emisiones de ciclo energético completo",
}
...
_DENSIDADES_PERFIL = {
    "GLEC v3.2 | Carretero | Diésel | Emisiones de ciclo energético completo": (
        0.832,
        "Smart Freight Centre, GLEC Framework v3.2, factor europeo de diésel: densidad 0,832 kg/L.",
    ),
    "GLEC v3.2 | Ferroviario | Diésel | Emisiones de ciclo energético completo": (
        0.832,
        "Smart Freight Centre, GLEC Framework v3.2, factor europeo de diésel: densidad 0,832 kg/L.",
    ),
    "GLEC v3.2 | Aéreo | Jet A1/A | Emisiones de ciclo energético completo": (
        0.802,
        "Smart Freight Centre, GLEC Framework v3.2, Jet Kerosene: densidad 0,802 kg/L.",
    ),
    "GLEC v3.2 | Marítimo | MDO/MGO VLSFO | Emisiones de ciclo energético completo": (
        0.890,
        "ANCAP, ficha de seguridad Gasoil Marino: densidad 890 kg/m³ a 15 °C. Se usa solo para convertir L a kg.",
    ),
    "GLEC v3.2 | Fluvial | MDO/MGO VLSFO | Emisiones de ciclo energético completo": (
        0.890,
        "ANCAP, ficha de seguridad Gasoil Marino: densidad 890 kg/m³ a 15 °C. Se usa solo para convertir L a kg.",
    ),
    "GLEC v3.2 | Marítimo | HFO VLSFO | Emisiones de ciclo energético completo": (
        0.991,
...
def _alcance_amigable(frontera: str) -> str:
    """Etiqueta comprensible para el usuario; mantiene la codificación técnica internamente."""
    return {
        "TTW": "Emisiones operativas durante el transporte",
        "WTW": "Emisiones del ciclo energético completo",
        "WTT": "Emisiones asociadas al suministro de la energía",
    }.get(frontera or "", "Alcance no especificado")
...
def calcular_segmento(seg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if metodo == "Intensidad de emisión":
        ...
        ef_wtw = _num(seg.get("ef_wtw_kgco2e_unidad"))
        ...
        if ef_wtw > 0 and (ef_wtt > 0 or ef_ttw > 0):
            raise ValueError("No combine un factor total con componentes separados para el mismo tramo.")
        if ef_wtt <= 0 and ef_ttw <= 0 and ef_wtw <= 0:
            raise ValueError("Informe un factor de emisión documentado para el tramo.")
        if not unidad_usuario:
            raise ValueError("Informe la unidad de consumo utilizada.")

        frontera = _determinar_frontera(ef_wtt, ef_ttw, ef_wtw)
        if ef_wtw > 0:
            em_wtt = 0.0
            em_ttw = 0.0
            em_total = q_factor_asignado * ef_wtw
        else:
    ...
    with st.sidebar.expander("Información metodológica", expanded=False):
        st.markdown(
            ...
            **Alcance de las emisiones**  
            La herramienta distingue internamente entre factores que representan solo la operación del transporte y factores que incorporan también el suministro de la energía. El usuario no necesita completar esta desagregación.
...
def formulario_segmento(catalogo: pd.DataFrame) -> None:
    ...
    if modo == "Carretero":
        ...
        opciones_info = [
            "No conozco el consumo — calcular por actividad e intensidad de emisión",
            "Tengo consumo real y factores documentados — cálculo avanzado por combustible o energía",
        ]
    ...
    with st.expander("¿Qué diferencia hay entre los perfiles?", expanded=False):
        st.markdown(
            ...
            **Perfil Uruguay · Emisiones operativas**  
            Usa parámetros nacionales y representa las emisiones asociadas al uso del combustible durante el transporte.

            **Perfil GLEC · Ciclo energético completo**  
            Es una referencia internacional e incorpora tanto el suministro de la energía como su uso durante el transporte.

            **Factor documentado manualmente**  
            Utilícelo solo cuando su empresa disponga de un factor propio, contractual, oficial o técnicamente documentado. La herramienta solicita únicamente el valor total publicado y su alcance general.
            """
        )
    ...
    if modo == "Marítimo" and metodo_objetivo == "Intensidad de emisión" and unidad_carga == "Contenedor ISO":
        ...
        perfil_recomendado_mar = (
            "GLEC v3.2 | Marítimo contenedor | Promedio industria | Reefer | Emisiones de ciclo energético completo"
            if es_reefer
            else "GLEC v3.2 | Marítimo contenedor | Promedio industria | Seco | Emisiones de ciclo energético completo"
        )
    ...
    if perfil_recomendado_mar and perfil_recomendado_mar in perfiles_modo:
        ...
        st.success(
            "No necesita informar el consumo del buque ni completar factores técnicos. "
            "El cálculo utiliza la distancia, los TEU equivalentes y la intensidad documentada del perfil seleccionado."
        )
    else:
        # Para facilitar el uso, si existen perfiles integrados se muestran primero.
        # La entrada manual queda como alternativa avanzada y no como opción predeterminada.
        opciones_perfil = (perfiles_modo + ["Entrada manual"]) if perfiles_modo else ["Entrada manual"]
        perfil = st.selectbox(
            "Fuente o perfil del factor",
            opciones_perfil,
            index=0,
            key=f"nuevo_perfil_{modo}",
            format_func=lambda x: "Tengo un factor propio documentado (opción avanzada)" if x == "Entrada manual" else x,
            help=(
                "La herramienta prioriza perfiles integrados compatibles. Use la opción manual solo si dispone de un factor propio, oficial o contractual documentado."
            ),
        )
    ...
    if metodo == "Intensidad de emisión":
        ...
        if perfil_data:
            ...
            if any(v > 0 for v in (int_wtt_teu, int_ttw_teu, int_wtw_teu)):
                ...
                intensidad_total = int_wtw if int_wtw > 0 else (int_wtt + int_ttw)
            ...
            if habilitar_factor_manual:
                ...
                alcance_manual = st.selectbox(
                    "¿Qué incluye el factor?",
                    [
                        "Solo las emisiones durante la operación del transporte",
                        "El ciclo energético completo, incluido el suministro de la energía",
                    ],
                    help="Esta información debe corresponder a la descripción de la fuente del factor.",
                )
                if unidad_int_manual == "g CO₂e/TEU-km":
                    if alcance_manual.startswith("Solo"):
                        int_ttw_teu = intensidad_manual
                    else:
                        int_wtw_teu = intensidad_manual
                else:
                    if alcance_manual.startswith("Solo"):
                        int_ttw = intensidad_manual
                    else:
                        int_wtw = intensidad_manual
            else:
        ...
        if perfil_data:
            ...
            factor_total_integrado = ef_wtw if ef_wtw > 0 else (ef_wtt + ef_ttw)
            ...
            if permitir_factor_energia_manual:
                ...
                alcance_factor_manual = st.selectbox(
                    "¿Qué incluye el factor?",
                    [
                        "Solo las emisiones durante la operación del transporte",
                        "El ciclo energético completo, incluido el suministro de la energía",
                    ],
                    key=f"alcance_factor_manual_{modo}",
                )
                ef_wtt = 0.0
                ef_ttw = factor_manual_total if alcance_factor_manual.startswith("Solo") else 0.0
                ef_wtw = factor_manual_total if not alcance_factor_manual.startswith("Solo") else 0.0
            else:
    ...
    boton_bloqueado = bool(metodo == "Consumo energético" and locals().get("energia_bloqueada", False))
    submitted = st.button(
        ...
        help=(
            "Seleccione el cálculo por actividad e intensidad o aporte factores energéticos documentados para habilitar este tramo."
    ...
    with st.expander("Notas metodológicas de la herramienta"):
        st.markdown(
            ...
            **2. Cálculo por intensidad**  
            La emisión se obtiene multiplicando la actividad del segmento por una intensidad documentada expresada en g CO₂e/tkm o, cuando corresponda, en g CO₂e/TEU-km. La herramienta conserva internamente el alcance metodológico del factor seleccionado.

            **3. Cálculo por consumo energético**  
            La emisión se obtiene multiplicando la cantidad de combustible o energía asignada a la carga por un factor de emisión documentado. El usuario no necesita desagregar componentes técnicos del factor.
            ...
            **7. Coherencia de agregación**  
            La herramienta no agrega segmentos con alcances metodológicos incompatibles ni con bases GWP diferentes. Esta verificación se realiza internamente para evitar comparaciones inconsistentes.
